...
CACHE_FNAME = 'Project_2_cache.json'
try:
...
CACHE_FNAME1 = 'Project_2_cache.json'
try:
...
def get_nearby_places_for_site(national_site):
    ...
    # coordurl = "https://maps.googleapis.com/maps/api/place/textsearch/json?"
    coordurl = "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?"

    params = {}
    # params['query'] = national_site1
    ...
    if nearby_data['status'] != 'OK':
        ...
        # lat = result1['results'][0]['geometry']['location']['lat']
        # lng = result1['results'][0]['geometry']['location']['lng']
        ...
        # make_request_using_cache2(sitesurl, params2)
        # siteresult = requests.get(sitesurl)
        # siteresult1 = siteresult.json()
...
def plot_sites_for_state(state_abbr):
    ...
    for x in sites:
        ...
        # result = requests.get(graph_coordurl)
        # result1 = result.json()
...
def plot_nearby_for_site(site_object):
    ...
    # graph_coordurl = "https://maps.googleapis.com/maps/api/place/textsearch/json?"
    # params4 = {}
    # params4['query'] = site_object.name
    # params4['type'] = 'park'
